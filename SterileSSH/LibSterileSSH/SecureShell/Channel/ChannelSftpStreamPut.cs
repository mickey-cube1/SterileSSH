...
using LibSterileSSH;
/*
class LibSterileSSH.SecureShell.OutputStreamPut:

This class is based on SharpSSH-1.1.1.13.src\SharpSSH\jsch\ChannelSftpStreamPut.cs .

*/
namespace LibSterileSSH.SecureShell
{
	internal class OutputStreamPut : AOutputStream
	{
		ChannelSftp sftp;
		byte[] handle;
		long[] _offset;
